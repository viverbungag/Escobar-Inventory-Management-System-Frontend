...
const InactiveMenuCategoryModal = ({headers, rows, 
    ...
    pageSize, totalPages, openViewInactiveModal,
    handleItemCheckboxChange, handleCloseViewInactiveModal,
    ...
    <Slide 
      ...
      <div className={styles["inactive-menu-category-modal__content"]}>
        <DataTable 
          ...
          tableState="inactive"
        />
        <ActivateButton label="Activate" onClick={handleActivateClick} disableCondition={selectedItemsCount <= 0}/>
        </div>
      </div>
    </Slide>
</Modal>
